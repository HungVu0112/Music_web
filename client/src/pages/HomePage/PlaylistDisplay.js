        ...
        <div className="playlistPage main-content">
            ...
            <div className="body">
                <div className="tool-bar">
                    ...
                    }).length === 0 ? (data.isShared === undefined ? (
                        <i className='bx bxs-heart like' onClick={handleAddFv}></i>
                    ) : (
                        <i className='bx bxs-heart like' onClick={handleAddFv2}></i>
                    )) : (data.isShared === undefined ? (
                        <i className='bx bxs-heart like' onClick={handleDislike} style={{color: "red"}}></i>
                    ) : (
                        <i className='bx bxs-heart like' onClick={handleDislike2} style={{color: "red"}}></i>
                    ))
                    }
                </div>
